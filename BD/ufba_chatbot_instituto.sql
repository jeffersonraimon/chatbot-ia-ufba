...
INSERT INTO `instituto` VALUES (1,'Instituto de Computação da UFBA','Fundado em 1980, o Instituto de Computação da UFBA é referência em ensino e pesquisa na área de computação.','1980-01-01','Promover a excelência em ensino, pesquisa e extensão na área de computação.','Ser referência nacional e internacional em computação.','Inovação, Integridade, Colaboração');
